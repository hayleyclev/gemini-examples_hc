...
# -*- coding: utf-8 -*-
"""
Created on Wed Mar 27 11:56:31 2024
...
def fac_shear_synth(E: xarray.Dataset, gridflag: int, flagdip: bool) -> xarray.Dataset:
    """
    for 3D sim, FAC up/down 0.5 degree FWHM
    """
    
    reconstruction_fn = '/Users/clevenger/Projects/data_assimilation/feb_12/lompe_outputs/509_runs/pfisr_supermag/large/nc_files/2023-02-12_103500.nc'
